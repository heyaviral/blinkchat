    ...
    <div className="min-h-screen bg-[#070707] text-white px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mt-12 text-zinc-300 leading-relaxed">
          BlinkChat was created to solve a surprisingly common problem: the lack
          of a fast, temporary way to connect and communicate with someone
          instantly.
        </p>

        <p className="mt-6 text-zinc-300 leading-relaxed">
          The idea originated during a casual game session of Skribbl.io with my
          cousins. My sister was playing on a tablet and didn't have access to
          WhatsApp or any other convenient messaging platform. To join the game,
          she had to manually type a long URL character by character, which was
          slow, frustrating, and completely unnecessary.
        </p>
        ...
        <p className="mt-6 text-zinc-300 leading-relaxed">
          Many communication platforms are designed for long-term relationships,
          communities, and persistent networks. While those platforms are
          incredibly useful, they are often excessive for situations where
          people simply need a temporary communication channel for a one-off
          task.
        </p>
        ...
        <p className="mt-6 text-zinc-300 leading-relaxed">
          Whether it's coordinating a game, sharing information during an event,
          helping someone access a link, collaborating briefly on a task, or
          creating an instant communication channel between people who may never
          need to talk again, BlinkChat is designed to make that process
          effortless.
        </p>
        ...
        <p className="mt-6 text-zinc-300 leading-relaxed">
          ...
          exceptionally well: create instant, disposable communication channels
